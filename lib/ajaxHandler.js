...
function AjaxHandler() {
    ...
    ajaxHandler.prototype.modifyFile = function (fileId, _ref4, _success12, failed) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: { name: name, model: model, teacher: teacher, course: course, docformat: docformat, fileformat: fileformat, upuid: upuid, origin: origin, desc: desc },
            dataType: "JSON",
            success: function success(data, state) {
    ...
    ajaxHandler.prototype.modifyUserInfo = function (username, _ref5, _success13, failed) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: { nickname: nickname, oldpwd: oldpwd, newpwd: newpwd, avator: avator, mail: mail, phone: phone, qq: qq, xid: xid, mid: mid },
            dataType: "JSON",
            success: function success(data, state) {
