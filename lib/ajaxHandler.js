...
function AjaxHandler() {
    ...
    ajaxHandler.prototype.statistics = function (_success22, failed) {
        _success22 = typeof _success22 === 'function' ? _success22 : new Function();
        failed = typeof failed === 'function' ? failed : new Function();
        $.ajax({
            url: API.statistics,
            type: 'GET',
    ...
    ajaxHandler.prototype.getRecommend = function (fid, _success23, failed) {
        _success23 = typeof _success23 === 'function' ? _success23 : new Function();
        failed = typeof failed === 'function' ? failed : new Function();
        $.ajax({
            url: API.getRecommend,
            type: 'GET',
            data: { fid: fid, username: $.cookie('username') },
            dataType: "JSON",
            success: function success(data, state) {
                //handleTokenFailed(data.status);
                _success23(data, state);
            },
            error: function error(data, state) {
                failed(data, state);
            }
    ...
    ajaxHandler.prototype.searchTag = function (kw, page, _success24, failed) {
        _success24 = typeof _success24 === 'function' ? _success24 : new Function();
        failed = typeof failed === 'function' ? failed : new Function();
        $.ajax({
            url: API.tagsearch,
            type: 'GET',
            data: { kw: kw, page: page },
            dataType: "JSON",
            success: function success(data, state) {
                // console.log(data,state)
                _success24(data, state);
            },
            error: function error(data, state) {
                failed(data, state);
            }
